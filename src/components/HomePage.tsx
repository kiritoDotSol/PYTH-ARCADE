...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto custom-scrollbar p-6 sm:p-10 relative">
      ...
      <div className="absolute inset-0 border-[20px] border-background pointer-events-none z-50 opacity-50" />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <header className="mb-24 pt-10 text-center relative">
          ...
          >
            ...
            <h1 className="text-7xl sm:text-[12rem] font-black text-foreground leading-[0.8] tracking-tighter italic uppercase mb-8 relative neon-text-purple">
              PYTH<br />
          ...
          >
            ...
            <p className="mt-8 text-muted text-[10px] font-mono uppercase tracking-[0.4em]">
        ...
        <section id="missions" className="scroll-mt-20 mb-20">
          <div className="flex items-center justify-between mb-12">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-3xl font-black text-foreground uppercase tracking-tighter italic">SELECT MISSION</h2>
            </div>
          </div>
              ...
              >
                <div className="arcade-card relative aspect-[4/5] overflow-hidden rounded-sm transition-all duration-300 transform group-hover:-translate-y-2">
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-end z-30">
                    ...
                    <h3 className="text-3xl font-black text-foreground italic tracking-tighter mb-3 uppercase group-hover:neon-text-lime transition-all">
                      {game.title}
                    </h3>
                    
                    <p className="text-muted text-[11px] leading-relaxed mb-8 font-mono uppercase tracking-tight">
                      {game.description}
                    </p>
                    ...
                    {game.status === 'AVAILABLE' ? (
                      ...
                      <div className="w-full bg-card border border-border text-muted font-black py-4 rounded-none flex items-center justify-center gap-3 uppercase tracking-widest text-sm cursor-not-allowed">
        ...
        {/* Arcade Footer Stats */}
        <section className="mt-32 grid grid-cols-2 md:grid-cols-4 gap-8 border-t-2 border-border pt-12">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono text-foreground uppercase">CONNECTED</span>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-[10px] font-mono text-muted uppercase tracking-widest">ACTIVE AGENTS</span>
            <span className="text-xs font-mono text-foreground uppercase tracking-widest">14,209</span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-[10px] font-mono text-muted uppercase tracking-widest">TOTAL VOLUME</span>
            <span className="text-xs font-mono text-foreground uppercase tracking-widest">$1.2B</span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-[10px] font-mono text-muted uppercase tracking-widest">SYSTEM VERSION</span>
            <span className="text-xs font-mono text-foreground uppercase tracking-widest">V2.5.0-STABLE</span>
          </div>
        </section>
      </div>
    </div>
